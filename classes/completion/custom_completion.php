...
/**
 * Version information for the Twinery module.
 *
 * @package    mod_twinery
...
namespace mod_twinery\completion;

use core_completion\activity_custom_completion;

/**
 * Activity custom completion subclass for the twinery.
 *
 * Class for defining mod_twinery's custom completion rules and fetching the completion statuses
 * of the custom completion rules for a given twinery instance and a user.
 *
 * @package    mod_twinery
 * @author     Stefan Weber (stefan.weber@think-modular.com)
 * @copyright  2025 think-modular
